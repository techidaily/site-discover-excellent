...
## Enhance Your Deck Setup in DEX 3 Using Shader Visuals From Shadertoy - Easy Installation Guide

![Using Shaders in DEX 3 DJ and Video Mixing Software](https://pcdj.com/vidupload/SHADER-demo.gif)

![Shaders for on-screen visualizations](https://i2.wp.com/pcdj.com/wp-content/uploads/2018/07/shader.png?resize=180%2C180&ssl=1 "shader")

Last week [we introduced DEX 3.11.0.1](https://tools.techidaily.com/pcdj/products/), the latest and greatest iteration of our top DJ mixing software for the versatile DJ, along with ‘Shader’ support.
...
[DEX 3.11](https://tools.techidaily.com/pcdj/products/) is designed to display Shaders anytime you’re mixing audio, but you can select ‘No Shader’ from the Shader drop down menu located at the top of the DEX 3 video skins if you prefer to not use Shaders. You can easily add additional Shaders from the Shader top down menu and edit the existing list of Shaders using the ‘Edit Shaders’ option.
